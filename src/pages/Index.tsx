...
import { Search, Sparkles, Target, Calendar, LogIn, UserPlus, LayoutDashboard } from "lucide-react";
...
const Index = () => {
  ...
  const features = [
    ...
    { icon: Calendar, title: t("feat3Title"), desc: t("feat3Desc") },
  ];
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="relative z-10 flex flex-col items-center text-center px-6 pt-16 pb-24 max-w-3xl mx-auto">
        ...
        <ScrollReveal delayMs={160} className="w-full max-w-lg">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-24">
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <ScrollReveal key={f.title} delayMs={i * 100}>
              <div className="p-6 rounded-xl bg-card border border-border card-shadow hover:border-primary/30 transition-colors">
