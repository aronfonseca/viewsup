  ...
  return (
    ...
    >
      ...
      <div className="p-5 space-y-4">
        <div>
          <p className="text-xs text-white/50 mb-1">{t("agencyPreviewAnalysisFor")}</p>
        ...
        <div className="rounded-lg p-3 border" style={{ borderColor: `${accent}40`, background: `${accent}10` }}>
          <p className="text-[11px] uppercase tracking-wider mb-1" style={{ color: accent }}>{t("agencyPreviewInsight")}</p>
          <p className="text-xs text-white/80 leading-relaxed">
            {t("agencyPreviewInsightText")}
          </p>
        </div>

        <div className="flex items-center justify-between pt-2 border-t border-white/10">
          <span className="text-[10px] text-white/40">{t("agencyPreviewGeneratedBy")} {agencyName}</span>
          <span
            className="text-[10px] font-semibold px-2 py-0.5 rounded-full"
            style={{ background: `${accent}22`, color: accent }}
          >
            {t("agencyPreviewPoweredBy")}
          </span>
        </div>
      </div>
    </div>
