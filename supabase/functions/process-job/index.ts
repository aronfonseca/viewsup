...
11. trendRadar: Generate 5 trends EXCLUSIVELY specific to the client's detected niche. FORBIDDEN: generic Instagram tips like 'hook', 'visual proof', 'series'. REQUIRED: research actual trending content formats, topics, and styles within the specific industry (e.g., for fitness: transformation challenges, workout splits, supplement reviews; for real estate: neighborhood tours, price comparisons, mortgage tips; for tech: product unboxings, tutorial series, AI tool reviews). Each trend title must name a specific content format trending in that exact niche right now.
