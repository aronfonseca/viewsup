...
Deno.serve(async (req) => {
  ...
  // No explicit niches passed (e.g. the weekly cron call) → research every
  // niche. Pass { niches: [...] } explicitly to focus a single call on
  // specific niches only (used for on-demand/manual runs).
